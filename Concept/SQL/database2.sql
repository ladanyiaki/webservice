...
CREATE TABLE shippingAddress(									-- Szállítási cím tábla (adott vásárlónak több címe lehet)
...
INSERT INTO shippingaddress VALUES ('Budapest I. 1001 fő u. 1',1);		-- Próbavásárló két lakcíme
INSERT INTO shippingaddress VALUES ('Miskolc 3500 ló u. 14',1);

INSERT INTO cart (customerID,productID,cartQuantity) VALUES (1,1,5);
INSERT INTO cart (customerID,productID,cartQuantity) VALUES (1,2,5);
INSERT INTO cart (customerID,productID,cartQuantity) VALUES (1,1,4);
INSERT INTO cart (customerID,productID,cartQuantity) VALUES (1,2,1);
INSERT INTO cart (customerID,productID,cartQuantity) VALUES (1,5,5);
INSERT INTO cart (customerID,productID,cartQuantity) VALUES (1,5,3);
INSERT INTO cart (customerID,productID,cartQuantity) VALUES (1,6,1);
INSERT INTO cart (customerID,productID,cartQuantity) VALUES (1,7,4);
*/
...
*/
SELECT c.customerID, c.productID, SUM(c.cartQuantity), p.productName, p.productID, p.productPrice, p.priceUnit  
FROM cart c, product p 
WHERE 2 =c.customerID AND c.productID=p.productID 
